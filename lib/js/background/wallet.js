...
chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
  ...
  if (!sender.tab ||
    ...
    if (request.greeting == "Coinevo coinevo-wallet-rpc Send Wallet Info") {
      sendResponse(wallet_info);
    } else if (request.greeting == "Coinevo coinevo-wallet-rpc Update Wallet Info") {
